...
(function ($) {
    ...
    function asyncRequestCallBack(element, options) {
    ...
    function asyncRequest(element, options) {
        ...
        if (confirm && typeof bootbox !== "undefined" && typeof bootbox.confirm === "function") {
            ...
            bootbox.confirm({
                ...
                callback: function (r) {
                    if (r) {
                        asyncRequestCallBack(element, options);
                    } else {
                        $("#popupmodals .modal:first").modal("show");
                        getFunction(element.getAttribute("data-ajax-cancel"), []).apply(element, arguments);
                    }
                }
            });
