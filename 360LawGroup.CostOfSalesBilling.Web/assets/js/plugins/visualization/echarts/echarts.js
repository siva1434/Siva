...
! function (e) {
    ...
    function t(e, t, o, r, s) {
        ...
        l._onmousemove = function (e) {
            ...
            l._mousein = !1
            }, this._tDom.className = "echarts-tooltip", this._tDom.style.position = "fixed", this.hasAppend = !1, this._axisLineShape && this.zr.delShape(this._axisLineShape.id), this._axisLineShape = new a({            
            zlevel: this.getZlevelBase(),
            z: this.getZBase(),
            invisible: !0,
            hoverable: !1
