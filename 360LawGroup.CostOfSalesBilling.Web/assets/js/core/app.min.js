...
$(function () {
    ...
    $(document).on("click", ".panel [data-action=collapse-title]", function (e) {
        $(this).next().find("[data-action=collapse]").click();
    });
    ...
    $("ul.navigation a").each(function () {
        if ($(this).attr("href") && window.location.href.toLowerCase().indexOf($(this).attr("href").toLowerCase()) >= 0) {
            ...
            //    $('<span class="selected"></span>').appendTo(parentLi);
            //}
        }
    });
